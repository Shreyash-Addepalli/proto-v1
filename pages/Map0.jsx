...
function Map0() {
  ...
  const [lng, setLng] = useState(-9.146467999999999);
  const [lat, setLat] = useState(38.718956);
    ...
    const loadMap = async () => {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.watchPosition(function (position) {
          ...
          if (
            !insideCircle(
              { lat: 38.718956, lon: -9.146467999999999 },
              {
            ...
            new MapboxCircle({ lat: 38.718956, lng: -9.146467999999999 }, 40, {
              editable: false,
  ...
  return (
    <div>
      <ActiveMintsNavbar name="Breakpoint x proto" />
      <div
        ref={mapContainer}
      ...
      ></div>
      <Drawer0 name="Breakpoint x proto" loc="Lisbon, Portugal" />
    </div>
  );
}
